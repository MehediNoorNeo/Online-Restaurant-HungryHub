          ...
          <div class="col-md-6 col-lg-3">
            <div class="feature-card text-center p-4 h-100">
              <div class="feature-icon mb-3">
                <i class="fas fa-shipping-fast text-warning fs-1"></i>
              </div>
              <h5 class="fw-bold mb-3">Fast & Reliable Delivery</h5>
              <p class="text-muted">Real-time tracking, punctual riders, and warm food on arrival.</p>
            </div>
          </div>
